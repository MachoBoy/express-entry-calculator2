const PartDSource = {
  ADDTIONAL_HEADER: ['Additional points', 'Maximum 600 points'],
  ...
  ADDITIONAL_DATA: [
    ...
    { text: 'Arranged employment - NOC 00', value: 200 },
    { text: 'Arranged employment – any other NOC 0, A or B ', value: 50 },
    { text: 'Provincial or territorial nomination', value: 600 }
  ]
};

export default PartDSource;
